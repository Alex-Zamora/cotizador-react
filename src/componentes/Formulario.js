...
class Formulario extends Component {
  ...
  // refs son para leer valores de los campos de un formulario
  ...
  cotizarSeguro = (e) => {
    ...
    // Leer el tipo de plan
    let plan = '';
    if (this.planBasicoRef.current.checked || this.planCompletoRef.current.checked) {
